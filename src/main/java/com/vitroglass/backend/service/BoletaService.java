...
public class BoletaService {
    ...
    public byte[] generarBoletaPdf(Cotizacion cotizacion) {
        ...
        try {
            ...
            Font boletaFont = new Font(Font.HELVETICA, 12, Font.BOLD, new Color(76, 175, 80));

            String numeroBoleta = "B001-" + String.format("%06d", cotizacion.getIdCotizacion());
            DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
            String fechaEmision = LocalDateTime.now().format(fmt);
            ...
            logoCell.addElement(new Paragraph("VitraGlass", titleFont));
            logoCell.addElement(new Paragraph("Vidriería profesional", subtitleFont));
            logoCell.addElement(new Paragraph("RUC: 20123456789", labelFont));
            ...
            Paragraph tipoDoc = new Paragraph("BOLETA DE VENTA", headerFont);
            tipoDoc.setAlignment(Element.ALIGN_RIGHT);
            infoCell.addElement(tipoDoc);

            Paragraph numDoc = new Paragraph(numeroBoleta, boletaFont);
            numDoc.setAlignment(Element.ALIGN_RIGHT);
            infoCell.addElement(numDoc);

            Paragraph fechaDoc = new Paragraph("Fecha emisión: " + fechaEmision, labelFont);
            fechaDoc.setAlignment(Element.ALIGN_RIGHT);
            infoCell.addElement(fechaDoc);

            String fechaCot = cotizacion.getFechaCotizacion() != null
                    ? cotizacion.getFechaCotizacion().format(fmt) : "-";
            Paragraph fechaCotP = new Paragraph("Fecha cotización: " + fechaCot, labelFont);
            fechaCotP.setAlignment(Element.ALIGN_RIGHT);
            infoCell.addElement(fechaCotP);
            ...
            lineCell.setBorderColor(new Color(76, 175, 80));
            ...
            PdfPCell dhCell = new PdfPCell(new Phrase("DETALLE DE VENTA", headerFont));
            ...
            totalLabelCell.setBorderColor(new Color(76, 175, 80));
            ...
            totalValueCell.setBorderColor(new Color(76, 175, 80));
            ...
            // ======== ESTADO DE PAGO ========
            document.add(new Paragraph(" "));
            PdfPTable pagoTable = new PdfPTable(1);
            pagoTable.setWidthPercentage(100);
            PdfPCell pagoCell = new PdfPCell();
            pagoCell.setBackgroundColor(new Color(232, 245, 233));
            pagoCell.setBorder(Rectangle.BOX);
            pagoCell.setBorderColor(new Color(165, 214, 167));
            pagoCell.setPadding(12);
            Paragraph pagoText = new Paragraph("PAGADO — Venta completada", 
                    new Font(Font.HELVETICA, 11, Font.BOLD, new Color(56, 142, 60)));
            pagoText.setAlignment(Element.ALIGN_CENTER);
            pagoCell.addElement(pagoText);
            pagoTable.addCell(pagoCell);
            ...
            Paragraph footer = new Paragraph(
                    ...
                    "Boleta de venta electrónica — " + numeroBoleta + "\n" +
